...
export default function InquiryForm() {
  ...
  const canSubmit = form.message && form.privacy;
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <button
            onClick={() => { setSubmitted(false); setStep(0); setForm({ inquiryType: "", companyName: "", name: "", email: "", phone: "", companySize: "", experience: "", message: "", privacy: false }); }}
            style={{
