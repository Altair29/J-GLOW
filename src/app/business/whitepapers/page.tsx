                  ...
                  >
                    <div className="aspect-[16/9] bg-gray-100 overflow-hidden">
                      {wp.thumbnail_url ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center" style={{ backgroundColor: theme['--biz-primary'] || '#1e3a5f' }}>
                    ...
                    <div className="p-5">
                      <div className="flex items-center gap-2 mb-2">
                        <Badge style={{ backgroundColor: '#fef3c7', color: '#92400e' }}>注目</Badge>
                      ...
                      <h3 className="text-lg font-bold text-gray-900 mb-2 group-hover:text-blue-700 transition-colors">{wp.title}</h3>
              ...
              return (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    <h3 className="text-base font-bold text-gray-900 mb-1 line-clamp-2 group-hover:text-blue-700 transition-colors">{wp.title}</h3>
                    {wp.summary && <p className="text-xs text-gray-500 line-clamp-2">{wp.summary}</p>}
                    <span className="inline-block mt-3 text-sm font-medium" style={{ color: theme['--biz-primary'] || '#1e3a5f' }}>
